...
const buidlerConfig: HardhatUserConfig = {
  ...
  networks: {
    ...
    kovan: {
      url: "https://mainnet.infura.io/v3/4c3537bc73d6456fa65803d0fbb8427c",
      chainId: 1,
      gasPrice: DEFAULT_GAS_PRICE,
    ...
    ganache: {
      ...
      chainId: 5777,
      accounts: {
        mnemonic: 'sketch plate usage update cactus arrow pioneer clutch satisfy remember caution crush',
        path: "m/44'/60'/0'/0",
        initialIndex: 0,
        count: 20,
      },
